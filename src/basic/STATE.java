...
public class STATE {
	...
	//Xiatao
	List<Integer> terminalNodes = new ArrayList<Integer>();
		...
		for(int i = 0; i < S_total_num ; i++)
		{
			...
			{   
				...
				if(ret[1] != -1)
				{
					...
					//Xiatao
					STATE_NODE childNode = list.get(j);
					childNode.addParentStateNodeById(i, ret);
				}
	...
	//Xiatao
	public List<Integer> getTerminalNodes () {
